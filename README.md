...
This is a Sample Chat App demonstrates the use of EnableX (https://www.enablex.io/cpaas/) platform Server APIs and Android Toolkit to build 1-to-1 Chat Application.  It allows developers to ramp up on app development by hosting on their own devices.
